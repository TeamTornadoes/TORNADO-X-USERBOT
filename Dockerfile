...
#Import Gudz
RUN wget https://raw.githubusercontent.com/TeamTornadoes/TORNADO-X-USERBOT/master/tornado-x-botmain.py
RUN wget https://raw.githubusercontent.com/TeamTornadoes/TORNADO-X-USERBOT/master/requirements.txt
#Start Fumkin
RUN pip3 install -r requirements.txt

CMD ["python3","tornado-x-botmain.py"]
