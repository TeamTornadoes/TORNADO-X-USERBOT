"""Check if Tornadobot alive. If you change these, you become the gayest gay such that even the gay world will disown you."""
...
pm_caption += f"┣•➳➠ `ᴄʜᴀɴɴᴇʟ:` [ᴊᴏɪɴ](https://t.me/TORNADO_UB_SUPPORT)\n"
pm_caption += f"┗━━━━━━━━━━━━━━━━━━━\n"
pm_caption += f" ||•|| sᴇᴄᴜʀɪᴛʏ ʙʏ ғɪʀᴇ-x ||•||\n"
pm_caption += " [ɢɪᴛʜᴜʙ](https://github.com/TeamTornadoes/TORNADO-X-USERBOT) • [ɢʀᴏᴜᴘ](https://t.me/FireXUserBot)"
...
CMD_HELP.update(
    {
        "alive": "**ALive**\
\n\n**Syntax : **`.alive`\
\n**Usage :** Check if Tornadobot UserBot is Alive"
    }
)
